self.addEventListener('install', (e) => {
  e.waitUntil(
    caches.open('xslt3fiddlePWA-v1').then((cache) => cache.addAll([
      ...
      'https://cdnjs.cloudflare.com/ajax/libs/ace/1.36.2/ace.js',
      'https://cdnjs.cloudflare.com/ajax/libs/ace/1.36.2/mode-xml.js',
      'https://cdnjs.cloudflare.com/ajax/libs/ace/1.36.2/mode-html.js',
      'https://cdnjs.cloudflare.com/ajax/libs/ace/1.36.2/mode-json.js',
