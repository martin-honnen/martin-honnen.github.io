self.addEventListener('install', (e) => {
  e.waitUntil(
    caches.open('xslt3fiddlePWA-v1').then((cache) => cache.addAll([
      ...
      'https://cdnjs.cloudflare.com/ajax/libs/ace/1.29.0/ace.js',
      'https://cdnjs.cloudflare.com/ajax/libs/ace/1.29.0/mode-xml.js',
      'https://cdnjs.cloudflare.com/ajax/libs/ace/1.29.0/mode-html.js',
      'https://cdnjs.cloudflare.com/ajax/libs/ace/1.29.0/mode-json.js',
