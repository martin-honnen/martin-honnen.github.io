...
<!-- Many of these parameters are shadowed by variables (see
   ...
   <xsl:param name="align-char-processing" select="true()"/>
   ...
   <xsl:param name="formal-object-numbers" as="xs:string" select="'true'"/>
   <xsl:param name="use-label-numeration" as="xs:string" select="'false'"/>
   ...
   <xsl:param name="mediaobject-percentage-of-intrinsic-size"
              as="xs:string"
              select="'false'"/>
   <xsl:param name="cos-number-from" as="xs:string" select="'verbatim section'"/>
   <xsl:param name="label-wrapper" as="xs:string?" select="()"/>
   <xsl:param name="prefer-xrefstyle" as="xs:string" select="'false'"/>
   ...
   <xsl:variable name="vp:dynamic-parameters" as="map(xs:QName, item()*)">
      <xsl:map>
         ...
         <xsl:map-entry key="QName('', 'align-char-processing')"
                        select="$align-char-processing"/>
         ...
         <xsl:map-entry key="QName('', 'formal-object-numbers')"
                        select="$formal-object-numbers"/>
         <xsl:map-entry key="QName('', 'use-label-numeration')" select="$use-label-numeration"/>
         ...
         <xsl:map-entry key="QName('', 'cos-number-from')" select="$cos-number-from"/>
         <xsl:map-entry key="QName('', 'label-wrapper')" select="$label-wrapper"/>
         <xsl:map-entry key="QName('', 'prefer-xrefstyle')" select="$prefer-xrefstyle"/>
      </xsl:map>
   </xsl:variable>
</xsl:stylesheet>
