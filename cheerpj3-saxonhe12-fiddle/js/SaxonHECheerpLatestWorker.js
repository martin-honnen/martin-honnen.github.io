importScripts("https://cjrtnc.leaningtech.com/3.1/cj3loader.js"); //importScripts("https://cjrtnc.leaningtech.com/3_20241216_574/cj3loader.js"); //importScripts("https://cjrtnc.leaningtech.com/3_20241213_572/cj3loader.js"); //importScripts("https://cjrtnc.leaningtech.com/3.0/cj3loader.js");
...
onmessage = async (e) => {
  ...
  if (task === 'transform') {
    await transform(data.input, data.code, data.inputType, data.xsltBaseURI, data.inputBaseURI);
  }
  else if (task === 'xquery') {
	  await xquery(data.input, data.code, data.inputType, data.xqueryBaseURI, data.inputBaseURI);  
  }
  else if (task === 'xpath') {
	  await xpath(data.input, data.code, data.inputType, data.xpathBaseURI, data.inputBaseURI);  
  }
}
