function schematronValidate(input, xslt, xsltBaseURI, inputBaseURI, resultsSelect) {

  if (!autoEvaluation)
	  setDocument(resultEditor, "Validating your XML against your Schematron...", "text");

  mausotronWorker.postMessage({ task: 'schematron-validate', data : { input : input, code: xslt, xsltBaseURI: xsltBaseURI, inputBaseURI: inputBaseURI }});
/*   if (saxonInitialized) {
	  try {
