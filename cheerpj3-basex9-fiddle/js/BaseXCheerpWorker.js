importScripts("https://cjrtnc.leaningtech.com/3.0/cj3loader.js");//importScripts('https://cjrtnc.leaningtech.com/3.0rc2/cj3loader.js');
...
(async () => {
  ...
  lib = await cheerpjRunLibrary("/app/cheerpj3-basex9-fiddle/BaseX974.jar");
