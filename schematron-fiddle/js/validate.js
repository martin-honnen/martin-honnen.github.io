...
const schxsltVersions = {
  ...
  'schxslt2-1.10.3' : 'schxslt/schxslt2-1.10.3/run-pipeline-for-svrl-and-apply-to-schema.xsl.sef.json',
  'schxslt2-1.5' : 'schxslt/schxslt2-1.5/run-pipeline-for-svrl-and-apply-to-schema.xsl.sef.json',
